...
(function ($, window, document, undefined) {
    ...
    var download = function (content) {
        ...
        if (this.options.useDataUri) { // not supported by IE: http://caniuse.com/#feat=datauri
            ...
            $form.append($csrf, $type, $filename, $content).appendTo('body').submit();
        }
    };
     ...
     * @constructor
     */
    function GridExport(element, options) {
     ...
     */
    GridExport.prototype.init = function () {
        var self = this;
     ...
     */
    GridExport.prototype.csv = function () {
     ...
     */
    GridExport.prototype.excel = function () {
     ...
     */
    GridExport.prototype.html = function () {
        var css = cssFile(this.options.cssFile),
     ...
     * Export to xml
     */
    GridExport.prototype.xml = function () {
     ...
     * Export to pdf
     */
    GridExport.prototype.pdf = function () {
        ...
        doc.setProperties({
            ...
            author: '2amigOS! GridExport Plugin',
     ...
     * Export to json
     */
    GridExport.prototype.json = function () {
