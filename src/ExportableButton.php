...
class ExportableButton extends ButtonDropdown
{
     ...
     */
    public $types = [
        TypeHelper::CSV => 'CSV <span class="label label-default pull-right">.csv</span>',
        TypeHelper::XLSX => 'Excel 2007+ <span class="label label-default pull-right">.xlsx</span>',
        TypeHelper::ODS => 'ODS <span class="label label-default pull-right">.ods</span>',
        TypeHelper::JSON => 'JSON <span class="label label-default pull-right">.json</span>',
        TypeHelper::XML => 'XML <span class="label label-default pull-right">.csv</span>',
        TypeHelper::TXT => 'Text <span class="label label-default pull-right">.txt</span>'
    ];
